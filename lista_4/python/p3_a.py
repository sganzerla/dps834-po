...
class Problem:
    def __init__(self):
        ...
        self.mdl.Maximize(-2 * self.x1 + 1 * self.x2 + 1 * self.x3)
        
        self.mdl.Add(3 * self.x1 + 1 * self.x2 + 1 * self.x3 + 1 * self.x4 == 60)
        self.mdl.Add(1 * self.x1 - 1 * self.x2 + 2 * self.x3 + 1 * self.x5 == 10)
        self.mdl.Add(1 * self.x1 + 1 * self.x2 - 1 * self.x3 + 1 * self.x6 == 20)
